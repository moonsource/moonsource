...
send(msg.chat_id_, msg.id_,"\n⌯  العضو ➪︎ ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n⌯  تم رفعه "..RTPA.." هنا\n")   
...
if Tshakert == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n⌯  العضو ➪︎ ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n⌯  تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Tshake:Special:User"..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_, '⌯  تم تعطيل ➪︎ الحظر ~ والطرد ')
return false
end
end
...
send(msg.chat_id_, msg.id_, '⌯ تم تفعيل ➪︎ الحظر ~ والطرد ')
return false
end
end
...
send(msg.chat_id_, msg.id_, '⌯  تم تعطيل رفع ➪︎ الادمن ~ المميز ')
return false
end
end
...
send(msg.chat_id_, msg.id_, '⌯ تم تفعيل رفع ➪︎ الادمن ~ المميز ')
return false
end
end
...
tt = "\n⌯ تستطيع اضافة مايلي !\n⌯  دالة عرض الاسم ➪︎{`name`}\n⌯ دالة عرض المعرف ➪︎{`user`}"
...
send(msg.chat_id_, msg.id_,"⌯   تم تغير رد المطور الى ➪︎ "..Teext)
end
...
send(msg.chat_id_, msg.id_,"⌯   تم تغير رد المنشئ الاساسي الى ➪︎ "..Teext)
end
...
send(msg.chat_id_, msg.id_,"⌯   رتبتك في البوت ➪︎ "..rtp)
end
if text == "اسمي"  then 
...
database:srem(bot_id.."Tshake:Ban:User"..msg.chat_id_,result.id_)
database:srem(bot_id.."Tshake:Muted:User"..msg.chat_id_,result.id_)
usertext = "\n⌯   العضو ➪︎ ["..result.title_.."](t.me/"..(username or "kenwa")..")"
status  = "\n⌯  تم الغاء القيود عنه"
...
database:srem(bot_id.."Tshake:Muted:User"..msg.chat_id_,result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = "\n⌯   العضو ➪︎ ["..data.first_name_.."](t.me/"..(data.username_ or "kenwa")..")"
status  = "\n⌯  تم الغاء القيود عنه"
...
send(msg.chat_id_, msg.id_,"⌯  الحظر العام ➪︎ "..GBan.."\n⌯  الحظر ➪︎ "..Ban.."\n⌯  الكتم ➪︎ "..Muted)
else
...
"\n⌯  علامة ال {✖} تعني معطل"..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\n⌯ الروابط ➪︎ "..lock_links..
"\n".."⌯ المعرفات ➪︎ "..lock_user..
"\n".."⌯ التاك ➪︎ "..lock_hash..
"\n".."⌯ البوتات ➪︎ "..lock_bots..
"\n".."⌯ التوجيه ➪︎ "..lock_fwd..
"\n".."⌯ التثبيت ➪︎ "..lock_pin..
"\n".."⌯ الاشعارات ➪︎ "..lock_tagservr..
"\n".."⌯ الماركدون ➪︎ "..lock_mark..
"\n".."⌯ التعديل ➪︎ "..lock_edit..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\n".."⌯ الكلايش ➪︎ "..lock_spam..
"\n".."⌯ الكيبورد ➪︎ "..lock_inlin..
"\n".."⌯ الاغاني ➪︎ "..lock_vico..
"\n".."⌯ المتحركه ➪︎ "..lock_gif..
"\n".."⌯ الملفات ➪︎ "..lock_file..
"\n".."⌯ الدردشه ➪︎ "..lock_text..
...
⌯ لعبة البات ➪︎ بات
⌯ لعبة التخمين ➪︎ خمن
⌯ لعبه الاسرع ➪︎ الاسرع
⌯ لعبة السمايلات ➪︎ سمايلات
⌯ لعبة المختلف ➪︎ المختلف
⌯ لعبة الامثله ➪︎ امثله
⌯ لعبة العكس ➪︎ العكس 
⌯ لعبة الحزوره ➪︎ حزوره
⌯ لعبة المعاني ➪︎ معاني
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
⌯ مجوهراتي ➪︎ لعرض عدد الارباح
⌯  بيع مجوهراتي + العدد ➪︎ لستبدال كل مجوهره ب50 رساله
]]
...
print('\27[30;33m➪︎➪︎ THE USER IS SAVE ME ↓\n➪︎➪︎ '..pv[i]..'\n\27[1;37m')
else
print('\27[30;31m➪︎➪︎ THE USER IS BLOCK ME ↓\n➪︎➪︎ '..pv[i]..'\n\27[1;37m')
...
print('\27[30;34m➪︎➪︎ THE BOT IS NOT ADMIN ↓\n➪︎➪︎ '..group[i]..'\n\27[1;37m')
...
database:srem(bot_id..'Tshake:Chek:Groups',group[i])  
q = q + 1
print('\27[30;35m➪︎➪︎ THE BOT IS LEFT GROUP ↓\n➪︎➪︎ '..group[i]..'\n\27[1;37m')
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusKicked" then
database:srem(bot_id..'Tshake:Chek:Groups',group[i])  
q = q + 1
print('\27[30;36m➪︎➪︎ THE BOT IS KICKED GROUP ↓\n➪︎➪︎ '..group[i]..'\n\27[1;37m')
end
...
NumFile = NumFile + 1
TextS = TextS..'*'..NumFile.."~⪼* {`"..name..'`} ➪︎ '..CeckFile..'\n[- File Information]('..Info..')\n'
end
...
t = "*⌯   بالتاكيد تم تعطيل وحذف ملف ➪︎ {"..file.."} \n✔*"
end
...
if file_bot then
io.close(file_bot)
t = "*⌯   بالتاكيد تم تنزيل وتفعيل ملف ➪︎ {"..file.."} \n✔*"
else
...
⌯  [TshAkE iNDT](https://t.me/ZX_XX/4611)
 ...
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
⚣︎  [TWS TshAkE](https://t.me/A_5bot)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
if text == 'حظر' then
sendText(Id_Sudo,'⌯   لشخص ➪︎ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n⌯   تم حظره من التواصل ',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'BaN:In:User',data.id_)  
return false  
end 
if text =='الغاء الحظر' then
sendText(Id_Sudo,'⌯  الشخص ➪︎ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n⌯   تم الغاء حظره من التواصل ',msg.id_/2097152/0.5,'md')
...
print('\27[30;32m➪︎➪︎ يرجى الاننتضار لحين تنظيف المجموعات الوهميه ␈︎\n\27[1;37m')
local list = database:smembers(bot_id..'Tshake:UsersBot')  
for k,v in pairs(list) do 
